...
<head>
    ...
    <title>Laravel Ajax CRUD - Kayla Mayrafadini XI PIONEER</title>
    <style>
        body {
...
<body>
    ...
    <div class="container" style="margin-top: 50px">
        <div class="row">
            <div class="col-md-12">
                <h4 class="text-center">LARAVEL CRUD AJAX - Kayla Mayrafadini XI PIONEER</a></h4>
